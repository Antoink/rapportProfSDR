...
def build_report_for_player(
    ...
    # Rien de ré-inventé automatiquement pour l'entretien : si le staff n'a
    # rien écrit, ces champs restent vides dans le rapport (mieux vaut vide
    # que du texte halluciné).
